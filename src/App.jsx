...
export default function VetBaraPrototype() {
  ...
  async function handleDownloadCentreAuditPackage() {
    if (!activeSessionToken) {
      setCentreAuditExportError("Centre audit export requires backend Centre session.");
      return;
    }
    ...
    try {
      ...
      setCentreAuditExportError("Centre audit package is not available right now.");
    } finally {
